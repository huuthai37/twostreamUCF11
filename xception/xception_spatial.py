...
if train:
    if retrain:
        result_model.load_weights('weights/xception_spatial_{}e.h5'.format(old_epochs))
    ...
    for e in range(epochs):
        ...
        result_model.save_weights('weights/xception_spatial_{}e.h5'.format(old_epochs+1+e))

        with open('data/XceptionSpatial_{}_{}e'.format(old_epochs, epochs), 'wb') as file_pi:
            pickle.dump(histories, file_pi)

else:
    result_model.load_weights('weights/xception_spatial_{}e.h5'.format(epochs))
